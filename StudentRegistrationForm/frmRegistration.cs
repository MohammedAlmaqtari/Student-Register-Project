...
namespace StudentRegistrationForm
{
    public partial class frmRegistration : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            name, email, gender, birthdate, country, color);

            this.Size = new System.Drawing.Size(OriginalSize.Width, OriginalSize.Height + 100);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string data = txtName.Text + "\n" + // Name
                          ...
                          (cmbCountry.SelectedItem != null ? cmbCountry.SelectedItem.ToString() : "") + "\n" + // Country
                          lblSelectedColor.Text.Replace("Selected Color: ", "") + "\n" + // Favorite Color
                          (picStudent.Image != null ? "student_picture.jpg" : "NoImage") + "\n"; // Image Path

            // Save to text file
            System.IO.File.WriteAllText("student_data.txt", data);
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            if (!System.IO.File.Exists("student_data.txt"))
            {
            ...
            string[] lines = System.IO.File.ReadAllLines("student_data.txt");
            ...
            if (System.IO.File.Exists("student_picture.jpg") && lines[7] == "student_picture.jpg")
            {
